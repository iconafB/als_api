...
class lead_history_tbl(SQLModel,table=True):
    ...
    camp_code:str=Field(default=None,nullable=False,foreign_key="campaign_tbl.camp_code")
    ...
    #info:Optional["info_tbl"]=Relationship(back_populates="lead_histories")
    #campaign:Optional["campaign_tbl"]=Relationship(back_populates="lead_histories")
    #rule:Optional['rules_tbl'] =Relationship(back_populates="lead_histories")
